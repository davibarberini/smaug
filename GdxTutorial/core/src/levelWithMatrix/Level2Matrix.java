...
public class Level2Matrix extends ScreenAdapter {
  public Player p1;
  public static int WIDTH;
  public static int HEIGHT;
  public static int mapCol = 44;
  public static int mapLin = 25;
  ...
  public Level2Matrix(MyGdxGame game) {
	  this.game = game;
	  //mapWriter = new MapFileWriter(mapLin, mapCol);
	  //mapWriter.writeMap(map, "Level2");
	  mapReader = new MapFileReaderMatrix(mapLin, mapCol);
	  map = mapReader.readMap("Level2");
